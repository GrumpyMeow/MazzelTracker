...
#define REST_TIME_S (60 * 60)  // Slow resting uplink frequency in seconds
...
#define USB_POWER_VOLTAGE 3.38      // Above this voltage, assume we have unlimited power (4.1 is typical)
...
#define BATTERY_UPDATE_RATE_MS (1 * 60 * 1000)      // How often to sample battery voltage
